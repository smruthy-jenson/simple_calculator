      ...
      <div style={{ width: '600px' }} className='bg-light p-5 rounded'>
        ...
        <form className='mt-5'>
          ...
          <Stack direction="row" spacing={2}>
            <Button onClick={handleCalculation} disabled={!principleAmountValid || !rateAmountValid || !yearAmountValid} style={{ width: '50%', height: '70px' }} className='bg-dark' variant="contained">CALCULATE</Button>
